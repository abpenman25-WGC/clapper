...
export function getDefaultSettingsState(): SettingsState {
  const state: SettingsState = {
    ...
    imageGenerationWorkflow: JSON.stringify(defaultWorkflowForImages),
    imageGenerationTurboWorkflow: '',
    imageFaceswapWorkflow: '',
    imageUpscalingWorkflow: '',
    imageDepthWorkflow: '',
    imageSegmentationWorkflow: '',
    videoGenerationWorkflow: JSON.stringify(defaultWorkflowForVideos),
    ...
    // Default voice: ParlerTTS Mini v0.1 via Hugging Face Pro (free, reliable)
    voiceGenerationWorkflow: JSON.stringify({
    ...
    audioLdmApiUrl: 'http://localhost:5002',
    musicGenApiUrl: 'http://localhost:5003',
