...
export const googleWorkflows: ClapWorkflow[] = [
  ...
  },
  {
    id: 'google://imagen-4',
    label: 'Imagen 4',
    description: 'Google Imagen 4 video generation model',
    tags: ['Imagen', 'video', '4'],
    author: 'Google (GCP Vertex AI)',
    thumbnailUrl: '',
    nonCommercial: false,
  ...
  },
  {
    ...
    description: 'Google Imagen 4 Flash video generation model (fast)',
    tags: ['Imagen', 'video', '4', 'flash'],
    author: 'Google (GCP Vertex AI)',
    thumbnailUrl: '',
    nonCommercial: false,
    engine: ClapWorkflowEngine.REST_API,
  ...
  },
  {
    ...
    label: 'Imagen 4 Pro',
    description: 'Google Imagen 4 Pro video generation model',
    tags: ['Imagen', 'video', '4', 'pro'],
    author: 'Google (GCP Vertex AI)',
    thumbnailUrl: '',
    nonCommercial: false,
    engine: ClapWorkflowEngine.REST_API,
  ...
  },
  {
    ...
    description: 'Google Imagen 4 Turbo video generation model',
    tags: ['Imagen', 'video', '4', 'turbo'],
    author: 'Google (GCP Vertex AI)',
    thumbnailUrl: '',
    nonCommercial: false,
    engine: ClapWorkflowEngine.REST_API,
